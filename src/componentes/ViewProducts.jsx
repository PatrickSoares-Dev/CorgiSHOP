        ...
        <div class="container mx-auto px-4">
            ...
            <div class="lg:col-span-3 lg:row-end-1">
                ...
                <div class="lg:order-2 lg:ml-5">
                    ...
                    <img class="h-full w-full max-w-full object-cover" src="./src/assets/img/Products/Roupinha-chucky/roupinha-chucky1.png" alt="" />
                    </div>
                </div>
                ...
                <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                    ...
                    <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                        <img class="h-full w-full object-cover" src="./src/assets/img/Products/Roupinha-chucky/roupinha-chucky2.png" alt="" />
                    </button>
                    <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center">
                        <img class="h-full w-full object-cover" src="./src/assets/img/Products/Roupinha-chucky/roupinha-chucky3.png" alt="" />
                    </button>
                    <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center">
                        <img class="h-full w-full object-cover" src="./src/assets/img/Products/Roupinha-chucky/roupinha-chucky5.png" alt="" />
                    </button>
                    </div>
                </div>
                </div>
            ...
            <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                ...
                <label class="">
                    ...
                    <p class="peer-checked:bg-sky-500 peer-checked:text-white rounded-lg border border-grey-400 px-6 py-2 font-bold">Tam. 00</p>
                </label>
                <label class="">
                    <input type="radio" name="type" value="Whole Bean" class="peer sr-only" />
                    <p class="peer-checked:bg-sky-500 peer-checked:text-white rounded-lg border border-grey-400 px-6 py-2 font-bold">Tam. 01</p>
                </label>
                <label class="">
                    <input type="radio" name="type" value="Groud" class="peer sr-only" />
                    <p class="peer-checked:bg-sky-500 peer-checked:text-white rounded-lg border border-grey-400 px-6 py-2 font-bold">Tam. 02</p>
                </label>
                </div>
                ...
                <label class="">
                    ...
                    <p class="bg-sky-500 peer-checked:text-white rounded-lg border border-gray-500 px-6 py-2 font-bold"></p>
                ...
                <label class="">
                    <input type="radio" name="subscription" value="12 Months" class="peer sr-only" />
                    <p class="bg-slate-950 peer-checked:text-white rounded-lg border border-gray-500 px-6 py-2 font-bold"></p>
                ...
                <div class="flex items-end">
                    <h1 class="text-3xl font-bold">R$ 79,99</h1>
                    <span class="text-base">/ a vista</span>
                </div>

                <button type="button" class="inline-flex items-center justify-center rounded-md border-2 border-transparent bg-teal-500 bg-none px-8 py-3 text-center text-sm font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-teal-700">
            ...
            <div class="lg:col-span-5">
                ...
                <nav class="flex gap-4">
                    ...
                    Avaliações
                    <span class="ml-2 block rounded-full bg-sky-500 px-2 py-px text-xs font-bold text-gray-100"> 358 </span>
                    </a>
                </nav>
                </div>
